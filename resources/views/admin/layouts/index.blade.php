...
<div id="wrapper">
   ...
   @include('admin.layouts.nav')
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="footer">
            <div class="pull-right">&copy; 2018-2019 <a href="http://soueo.cn/" target="_blank">soueo.cn</a>
            </div>
        </div>
    </div>
    <!--右侧部分结束-->
...
<script src="{{asset('org/admin/js')}}/plugins/slimscroll/jquery.slimscroll.min.js"></script>
<script src="{{asset('org/admin/js')}}/plugins/layer/layer.min.js"></script>

<!-- 自定义js -->
<script src="{{asset('org/admin/js')}}/hplus.js?v=4.1.0"></script>
<script type="text/javascript" src="{{asset('org/admin/js')}}/contabs.js"></script>

<!-- 第三方插件 -->
<script src="{{asset('org/admin/js')}}/plugins/pace/pace.min.js"></script>
