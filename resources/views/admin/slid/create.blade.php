        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>轮播图添加
                        <small class="text-danger">轮播图不能重复</small>
                    </h5>


                </div>
                <div class="ibox-content">
                    <form method="post" class="form-horizontal layui-form" action="{{route('admin.slid.store')}}">
                        @csrf
                        <div class="form-group">
                            <label class="col-sm-2 control-label">轮播图链接</label>

                            <div class="col-sm-10">
                                <input type="text"value="{{old('links')}}"  name="links" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <div class="layui-upload-drag" id="test10">
                                    @if(old('list_pic'))
                                        <img src="{{old('picture')}}" width="50px" height="50px">
                                        <input name="picture" type="hidden" value="{{old('picture')}}">
                                    @else
