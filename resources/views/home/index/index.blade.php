...
<div id="header">
    <div class="header-box">
        <h3 class="huany">{{shop_config('website.site_name')}}购物商城欢迎您的到来！</h3>
        ...
        <ul class="header-right">
            ...
            <li class="shouji bj">
                ...
                <div class="shouji1">
                    ...
                    <img src="{{asset('org/home/images')}}/mb_wangid.png" class="shouji4">
                    <div class="shouji2">
                        <p>通城客户端</p>
...
<!--搜索栏-->
<div class="toub_beij">
    <div class="logo"><a href=""><img src="{{shop_config('website.site_logo')}}" width="300px" height="86px"></a></div>
    <div class="search">
            ...
            <div class="font-item">
                ...
                <div class="font-item1">
                    ...
                    <div class="font-right">
                        <div>
                            <a href="#">
                                <img src="{{asset('org/home/images')}}/562f4971Na5379aba.jpg">
                            </a>
                            <a href="#">
                                <img src="{{asset('org/home/images')}}/54d9eef9N5bb8d27f.jpg">
                            </a>
                            <a href="#">
                                <img src="{{asset('org/home/images')}}/54d9ef02N99d26435.jpg">
                            </a>
                            <a href="#">
                                <img src="{{asset('org/home/images')}}/54d9ef10Nd206a236.jpg">
                            </a>
                            <a href="#">
                                <img src="{{asset('org/home/images')}}/54d9ef28N00328d44.jpg">
                            </a>
                            <a href="#">
                                <img src="{{asset('org/home/images')}}/54d9ef34N7cc61f4c.jpg">
                            </a>
                            <a href="#">
                                <img src="{{asset('org/home/images')}}/54d9ef3eN99aef1f0.jpg">
                            </a>
                            <a href="#">
                                <img src="{{asset('org/home/images')}}/54d9ef4cN4fe57f9b.jpg">
                            </a>
                        </div>
                    </div>
                    <div class="font-righty">
                        <a href="#">
                            <img src="{{asset('org/home/images')}}/5673a854N10856704.jpg">
                        </a>
                        <a href="#">
                            <img src="{{asset('org/home/images')}}/56a0376aN7de1bdcf.jpg">
                        </a>
                    </div>
                </div>
            </div>
...
<div id="lunbo">
    <ul id="one">
        <li><a href=""><img src="{{asset('org/home/images')}}/banner.jpg"></a></li>
        <li><a href=""><img src="{{asset('org/home/images')}}/banner1.jpg"></a></li>
        <li><a href=""><img src="{{asset('org/home/images')}}/banner.jpg"></a></li>
        <li><a href=""><img src="{{asset('org/home/images')}}/banner1.jpg"></a></li>
    </ul>
    <ul id="two">
...
<div class="bend_beij">
    ...
    <div class="bend_dhengh">
        ...
        <div class="jiank_meis">
            <div class="kuang_1">
                <a href="#">
                    <img src="{{asset('org/home/images')}}/jiank_meis.jpg">
            ...
            <div class="lunb_t">
                <div class="picScroll_left_1">
                    <div class="bd">
                        <ul class="picList">
                            <li>
                                <div class="pic"><a href="#" target="_blank"><img src="{{asset('org/home/images')}}/lengy.jpg" /></a></div>
        ...
        <div class="toum_">
            <ul>
                <li><a href="#"><img src="{{asset('org/home/images')}}/jiudi_kez.jpg">
                        <div class="jiank_meis_wenz_1">
                            <p>健康美食</p>
                        </div>
                    </a>
                </li>
                <li class="sdfs"><a href="#"><img src="{{asset('org/home/images')}}/xiux_yvl.jpg">
                        <div class="jiank_meis_wenz_1">
                            <p>休闲娱乐</p>
                        </div>
                    </a>
                </li>
                <li><a href="#"><img src="{{asset('org/home/images')}}/liren.jpg">
                        <div class="jiank_meis_wenz_1">
                            <p>丽人</p>
                        </div>
                    </a>
    ...
    <div class="zhoub">
        ...
        <div class="zhoub_neir">
            <ul>
                <li><a href="#"><img src="{{asset('org/home/images')}}/zoub.jpg"></a></li>
                <li><a href="#"><img src="{{asset('org/home/images')}}/zoub2.jpg"></a></li>
                <li><a href="#"><img src="{{asset('org/home/images')}}/zoub3.jpg"></a></li>
            </ul>
        </div>
    </div>
        ...
        <li>
            <div class="list-li-box">
                <a class="list-img" href="#" data-code="index01004-1" target="_blank">
                    <img src="{{asset('org/home/images')}}/meinv_1.jpg">
        ...
        <li>
            <div class="list-li-box">
                <a class="list-img" href="#" data-code="index01004-2" target="_blank">
                    <img src="{{asset('org/home/images')}}/meinv_2.jpg">
                    <span class="list-bg"></span>
                    <div class="list-cont">
        ...
        <li>
            <div class="list-li-box">
                <a class="list-img" href="#" data-code="index01004-3" target="_blank">
                    <img src="{{asset('org/home/images')}}/meinv_3.jpg">
                    <span class="list-bg"></span>
                    <div class="list-cont">
        ...
        <li>
            <div class="list-li-box">
                <a class="list-img" href="#" data-code="index01004-4" target="_blank">
                    <img src="{{asset('org/home/images')}}/meinv_4.jpg">
                    <span class="list-bg"></span>
                    <div class="list-cont">
                        ...
                        <div class="silder-scroll">
                            <div class="silder-main">
                                <div class="silder-main-img">
                                    <a href="#"><img src="{{asset('org/home/images')}}/liuceng_1.jpg" alt=""></a>
                                </div>
                                <div class="silder-main-img">
                                    <a href="#"><img src="{{asset('org/home/images')}}/2.png" alt=""></a>
                                </div>
                                <div class="silder-main-img">
                                    <a href="#"><img src="{{asset('org/home/images')}}/3.png" alt=""></a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="you_lirb">
                    <div class="shang_buf">
                        <div class="you_shangp_lieb ">
                            <a href="#"><img  class="you_tup_k" src="{{asset('org/home/images')}}/yic_001.jpg"></a>
                            <a href="#" class="_you_neir_biaot">林氏木业简约现代真皮转角客厅头层牛皮沙发家具2036</a>
                            <span>¥ 2599 .00</span>
                        </div>
                        <div class="you_shangp_lieb">
                            <a href="#"><img  class="you_tup_k" src="{{asset('org/home/images')}}/yic_002.jpg"></a>
                            <a href="#" class="_you_neir_biaot">林氏木业简约现代真皮转角客厅头层牛皮沙发家具2036</a>
                            <span>¥ 2599 .00</span>
                        </div>
                        <div class="you_shangp_lieb cnm">
                            <a href="#"><img  class="you_tup_k" src="{{asset('org/home/images')}}/yic_003.jpg"></a>
                            <a href="#" class="_you_neir_biaot">林氏木业简约现代真皮转角客厅头层牛皮沙发家具2036</a>
                            <span>¥ 2599 .00</span>
                        </div>
                    </div>
                    <div class="xia_buf">
                        <div class="you_shangp_lieb">
                            <a href="#"><img  class="you_tup_k" src="{{asset('org/home/images')}}/yic_004.jpg"></a>
                            <a href="#" class="_you_neir_biaot">林氏木业简约现代真皮转角客厅头层牛皮沙发家具2036</a>
                            <span>¥ 2599 .00</span>
                        </div>
                        <div class="you_shangp_lieb">
                        ...
                        <div class="you_shangp_lieb cnm">
                            <a href="#"><img  class="you_tup_k" src="{{asset('org/home/images')}}/yic_005.jpg"></a>
                            <a href="#" class="_you_neir_biaot">林氏木业简约现代真皮转角客厅头层牛皮沙发家具2036</a>
                            <span>¥ 2599 .00</span>
                        </div>
                    </div>
                ...
                <div class="louc_tup_qieh">
                    <div class="js-silder ws-slider">
                        <div class="silder-scroll">
                            <div class="silder-main">
                                <div class="silder-main-img">
                                    <a href="#"><img src="{{asset('org/home/images')}}/mm_yif.jpg" alt=""></a>
                                </div>
                                <div class="silder-main-img">
                                    <a href="#"><img src="{{asset('org/home/images')}}/2.png" alt=""></a>
                                </div>
                ...
                <div class="louc_tup_qieh">
                    <div class="js-silder ws-slider">
                        <div class="silder-scroll">
                            <div class="silder-main">
                                <div class="silder-main-img">
                                    <a href="#"><img src="{{asset('org/home/images')}}/qiche_tu.jpg" alt=""></a>
                                </div>
                                <div class="silder-main-img">
                                    <a href="#"><img src="{{asset('org/home/images')}}/mm_yif.jpg" alt=""></a>
                                </div>
...
<div class="tes_shnagp_beij">
    <div class="tes_shangp">
        ...
        <div class="tes_shangp_neir_k">
            <div class="tes_dat">
                <a href="#">
                    <h1><img class="tes_dat_dongh" src="{{asset('org/home/images')}}/te_se_shangp_da.jpg"></h1>
            ...
            <div class="tes_xiaot_beij">
                <div class="tes_xiaot_shang">
                    <div class="tes_xiaot_neir">
                        <a href="#">
                            <h1><img class="tes_xiaot_dongh" src="{{asset('org/home/images')}}/tes_shangp_xiao.jpg"></h1>
                    ...
                    <div class="tes_xiaot_neir tes_xiaot_wubian_kuang">
                        <a href="#">
                            <h1><img class="tes_xiaot_dongh" src="{{asset('org/home/images')}}/tes_shangp_xiao2.jpg"></h1>
                            <h2>海尔(Haier) BCD452WDPF 452</h2>
                            <span>¥ 506 .00</span>
                        </a>
                    </div>
                ...
                <div class="tes_xiaot_shang tes_xiaot_xia">
                    <div class="tes_xiaot_neir">
                        <a href="#">
                            <h1><img class="tes_xiaot_dongh" src="{{asset('org/home/images')}}/tes_shangp_xiao3.jpg"></h1>
                            <h2>海尔(Haier) BCD452WDPF 452</h2>
                            <span>¥ 506 .00</span>
                        </a>
                    </div>
                    <div class="tes_xiaot_neir tes_xiaot_wubian_kuang">
                        <a href="#">
                            <h1><img class="tes_xiaot_dongh" src="{{asset('org/home/images')}}/tes_shangp_xiao4.jpg"></h1>
                            <h2>海尔(Haier) BCD452WDPF 452</h2>
                            <span>¥ 506 .00</span>
                        </a>
                    </div>
        ...
        <div class="rem_shangp_beij_k">
            ...
            <div class="picScroll_left">
                ...
                <div class="bd">
                    <ul class="picList">
                        <li>
                            <div class="pic"><a href="#" target="_blank"><img src="{{asset('org/home/images')}}/rem_shangp.jpg" /></a></div>
                            <div class="title"><a href="#" target="_blank">佳能(Canon)EOS80D单反套机</a><span>¥ 506 .00</span></div>
                        </li>
                        <li>
                            <div class="pic"><a href="#" target="_blank"><img src="{{asset('org/home/images')}}/rem_shangp1.jpg" /></a></div>
