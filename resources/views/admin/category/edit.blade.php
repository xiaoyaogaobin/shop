    ...
    <div class="row content-tabs">
        ...
        <nav class="page-tabs J_menuTabs">
            <div class="page-tabs-content">
                <a href="javascript:;" class="active J_menuTab" data-id="index_v1.html">栏目编辑</a>
            </div>
        </nav>
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>栏目编辑 <small class="text-danger">栏目名称不能重复</small></h5>
                                    ...
                                    <div class="input-group-btn">
                                        <select name="pid" class="form-control custom-select dropdown-toggle" data-placeholder="Choose a Category" tabindex="1">
                                            ...
                                            @foreach($categorys as $v)
                                                <option  @if($category['pid']==$v['id']) selected @endif
                                                value="{{$v['id']}}">{!! $v['_name'] !!}
                                                </option>
                                                @endforeach
